...
import com.technoworld.BulkTradeHub.entity.BusinessProfile;
...
import com.technoworld.BulkTradeHub.repository.BusinessProfileRepository;
...
public class BusinessController {
    ...
    public String getProfilePage(Model model,Principal principal) {
        ...
        BusinessProfile businessProfile=(BusinessProfile)profileRepository.findByUser(user); 
        
        if (businessProfile == null) {
        	businessProfile = new BusinessProfile();
        } else {
            if (businessProfile.getPaymentMethods() != null && !businessProfile.getPaymentMethods().isEmpty()) {
            	businessProfile.setPaymentMethodsList(Arrays.asList(businessProfile.getPaymentMethods().split(",")));
            }
            businessProfile.setProfileImg(businessProfile.getProfileImg());
        }
    ...
    public String saveProfile(
        ...
        businessProfile.setBusinessType(businessType);
        ...
        businessProfile.setBankAccountHolderName(bankAccountHolderName);
        businessProfile.setBankAccountNumber(bankAccountNumber);
        businessProfile.setBankName(bankName);
        businessProfile.setIfscCode(ifscCode);
        businessProfile.setUpiId(upiId);
        businessProfile.setPaymentMethods(String.join(",", paymentMethodsList));

        if(profileImg !=null && !profileImg.isEmpty()) {
        	businessProfile.setProfileImg(profileImg.getBytes());
        }
        businessProfileRepository.save(businessProfile);

        return "redirect:/business/profile?success";
    }
    ...
    public ResponseEntity<byte[]> getProfileImage(Principal principal) {
        ...
        if (businessProfile != null && businessProfile.getProfileImg() != null) {
            return ResponseEntity.ok()
                    .contentType(MediaType.IMAGE_JPEG)
                    .body(businessProfile.getProfileImg());
        }
    ...
    public String displayProducts(Model model,@ModelAttribute("successMessage") String successMessage,Principal principal) {
		User user =  (User) ((UsernamePasswordAuthenticationToken) principal).getPrincipal();
        List<Product> productList = productRepository.findByUserOrderByIdDesc(user);
    ...
    public String updateProduct(@RequestParam Long id,
        ...
        try {
            ...
            if (existingProduct == null) {
                ...
                return "redirect:/business/showProducts";
            }
    ...
    public String searchProducts(@RequestParam("query") String query, Model model,Principal principal) {
    	User user =  (User) ((UsernamePasswordAuthenticationToken) principal).getPrincipal();
        List<Product> filteredProducts = productRepository.searchProductsByUser(query,user.getId());
        List<Category> categories=categoryRepository.findByUserAndStatusIn(user.getId(),List.of("Active", "Edit Approved"));
		List<Brand> brandsList=brandRepository.findByUserAndStatusIn(user.getId(),List.of("Active", "Edit Approved"));
    ...
    public String displayLowStockProduct(Model model,@ModelAttribute("successMessage") String successMessage,Principal principal) {
        ...
        model.addAttribute("successMessage", successMessage);
        model.addAttribute("products", productList);
        return "/business/lowStockProduct";
    }
    ...
    public String updateQuantity(@RequestParam Long id,
		...
		if (!existingProductOptional.isPresent()) {
		    redirectAttributes.addFlashAttribute("errorMessage", "Product not found!");
		    return "redirect:/business/showLowStockProduct";
		}
		existingProduct.setTotalQuantity(totalQuantity);
	...
	public String requestCategory(@RequestParam("name") String name, Principal principal, RedirectAttributes redirectAttributes) {
	    ...
	    return "redirect:/business/addCategory";
	}
	    ...
	    try {
	        if (name != null && !name.isEmpty()) {
	            ...
	            if (exists) {
	                ...
	                return "redirect:/business/addBrand";
	            }
    ...
    public String postProductPost(
        ...
        return "redirect:/business/searchProductForPost?productId=" + productId;
    }
    ...
    public String deleteProductPost(@PathVariable int id, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/business/showPost";
    }
